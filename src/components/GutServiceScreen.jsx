    ...
    <>
      ...
      <div className="gut--service__block" ref={GutRef}>
        ...
        <p>
          ...
          sound science. In collaboration with healthcare professionals, we use
          blood work analysis and gut health tests to address any issues that
          might appear.
        </p>
        <div className="card-wrapper mn">
          <div className="card-container card-container--bloodwork">
            ...
            <ul>
              <li className="card-list">One Time Plan to improve condition</li>
          ...
          <div className="blood-gut-text">
            ...
            <p>
              ...
              can arrange a new blood work test at a trusted clinic for an extra
              fee.
            </p>
            <img src={Blood} alt="" />
          </div>
        ...
        <div className="card-wrapper card-wrapper--gut mn">
          <div className="blood-gut-text">
            <p>
              It’s important to understand your gut microbiome composition, and
              we test for parasites, bacteria, and any other digestive problems.
              These tests help me make dietary adjustments and recommendations
